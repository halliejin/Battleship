...
class OceanTest {
	...
	void testShootAt() {
		...
		//TODO
		//More tests
		// put a new cruiser and test shootAt
	...
	void testGetShotsFired() {
		...
		//TODO
		//More tests
		// put a cruiser and count the fires
		Cruiser cruiser = new Cruiser();
		row = 6;
		column = 7;
		horizontal = true;
	...
	void testGetHitCount() {
		...
		//TODO
		//More tests
		// put a new cruiser and test the hit count
		Cruiser cruiser = new Cruiser();
		row = 6;
		column = 7;
		horizontal = true;
	...
	void testGetShipsSunk() {
		...
		//TODO
		//More tests
		// put a new cruiser and test the ship sunk
		Cruiser cruiser = new Cruiser();
		row = 6;
		column = 7;
		horizontal = true;
	...
	void testGetShipArray() {
		...
		//TODO
		//More tests
		// place a cruiser and get the ship array
		Cruiser cruiser = new Cruiser();
		int row = 6;
		int column = 7;
		boolean horizontal = true;
		cruiser.placeShipAt(row,column,horizontal,ocean);
		assertEquals("cruiser", shipArray[6][7].getShipType());
	}
